	...
	: wxFrame(NULL,wxID_ANY,title,wxDefaultPosition,wxSize(800,600))
{
	...
	wxBitmap toolbarLibrary(wxT("resource/toolbar/Library.png"),wxBITMAP_TYPE_PNG);
	wxBitmap toolbarBook(wxT("resource/toolbar/Book.png"),wxBITMAP_TYPE_PNG);
	wxBitmap toolbarArticle(wxT("resource/toolbar/Article.png"),wxBITMAP_TYPE_PNG);
	wxBitmap toolbarDocument(wxT("resource/toolbar/Document.png"),wxBITMAP_TYPE_PNG);
	wxBitmap toolbarFile(wxT("resource/toolbar/File.png"),wxBITMAP_TYPE_PNG);
	wxBitmap toolbarList(wxT("resource/toolbar/List.png"),wxBITMAP_TYPE_PNG);
